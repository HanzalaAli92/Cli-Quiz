...
let quiz = [
    ...
    },
    {
        ...
        choices: [
            ...
            chalk.italic.cyanBright.bold("(b). to find the remainder of a division operation"),
            chalk.italic.greenBright.bold("(c). to perform multiplication"),
        ],
        correct: chalk.italic.cyanBright.bold("(b). to find the remainder of a division operation")
    },
    {
